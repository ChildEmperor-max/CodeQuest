public class VeilOfTheAncients {
    public static void main(String[] args) {
        System.out.println("In the scrolls of code, an ancient secret sleeps,");
        /*
        System.out.println("Between the lines, a tale of magic creeps.");
